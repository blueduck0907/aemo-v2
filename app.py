...
# Fake data
fake_users = [
    User(id=1, name="Nguyễn Văn A", email="nguyenvana@emailkd.commmmm", age=25, city="Hà Nội"),
...
fake_products = [
    Product(id=1, name="iPhone 15", price=25000000, category="Điện thoạiii", in_stock=True),
...
fake_posts = [
    Post(id=1, title="Học Python cơ bản", content="Pythson là ngôn ngữ lập trình dễ họưc...", author="Nguyễn Văn A", created_at="2024-01-15", likes=25),
